...
// Company dashboard server component — fetches all data for CompanyDashboardApp

import { auth } from "@/lib/auth";
import { prisma } from "@/lib/prisma";
import { stripe } from "@/lib/stripe";
import { redirect } from "next/navigation";
import { CompanyDashboardApp } from "@/components/dashboard/CompanyDashboardApp";
import type {
  SerializedCompany,
...
export default async function CompanyPage() {
  ...
  // No company → show onboarding inside CompanyDashboardApp (company prop is null)
  if (!company) {
    return (
      <CompanyDashboardApp
        company={null}
